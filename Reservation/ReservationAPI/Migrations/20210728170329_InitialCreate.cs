    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 7, 28, 13, 3, 28, 759, DateTimeKind.Local).AddTicks(8470), 0f, "Nice 2016 model", 1, "Pierrefonds", new DateTime(2021, 7, 28, 13, 3, 28, 759, DateTimeKind.Local).AddTicks(6733), 1, null, "My Ford Focus", false });

            migrationBuilder.InsertData(
                table: "Items",
                columns: new[] { "Id", "Created", "DailyFee", "Description", "ItemTypeId", "Location", "Modified", "OwnerId", "Picture", "Title", "Withdrawn" },
                values: new object[] { 2, new DateTime(2021, 7, 28, 13, 3, 28, 759, DateTimeKind.Local).AddTicks(9657), 0f, "Old 2011 model", 1, "Ile-Bizzard", new DateTime(2021, 7, 28, 13, 3, 28, 759, DateTimeKind.Local).AddTicks(9649), 2, null, "My Nissan ", false });
